class Juego {
  constructor() {
    ...
    // temporizador y jugador
    this.tiempo = null;
    this.torry = null;

    // sonidos
    this.s_intro = null;      // intro.mp3
    this.s_musica = null;     // musica.mp3
    this.s_hoja = null;       // hojaganada.mp3
    this.s_ganaste = null;    // sganaste.mp3
    this.s_perdiste = null;   // sperdiste.mp3
  ...
  dibujar() {
    ...
    if (this.estado == 0) {
      ...
      textAlign(CENTER);
      textSize(30);
      text("El Emisario", width / 2.8, 75);
      textSize(20);
      text("Ray Bradbury ", width / 2.9, 100);
      textSize(16);
      text("Move el mouse para guiar a Torry", width / 2.1, 210);
      text("Evita los huesos y junta", width / 2.1, 230);
      text("10 hojas en 10 segundos", width / 2.1, 250);
      text("Presiona ENTER para comenzar", width / 2.1, 330);
      textSize(15);
      text("Hecho por Hernan Cortez - Arri Rosario", width / 2.1, 460);
